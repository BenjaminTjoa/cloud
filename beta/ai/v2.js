...
( () => {
                ...
                install_in_instance(t, {parameters: n}) {
                    ...
                    t.emit = async (e, t, n) => {
                        ...
                        for (let i = 0; i < s.global_listeners_.length; i++) {
                            ...
                            for (const e of s.callbackDecorators)
                                o = e(o);
                            r.push(o(e, t, {
                                ...n,
                                key: e
            ...
            e.exports = {
                ...
                install_in_instance: e => {
                    ...
                    for (const n in t) {
                        ...
                        e._.nariMethods[n] = i,
                        e[n] = async (...e) => {
                            const t = s.firstarg_options && "object" == typeof e[0] ? 0 : s.positional.length
                              , n = e.slice(0, t)
                              , r = e.slice(t)
                              , o = {}
                              , a = {}
            ...
            e.exports = {
                ...
                install_in_instance: (e, {parameters: t}) => {
                    ...
                    for (const s in n) {
                        ...
                        e._.properties[s] = i;
                        let r = null;
                        if ("object" == typeof n[s] ? (r = n[s],
                        r.factory && (r.value = r.factory({
                            parameters: t
                        }))) : "function" == typeof n[s] && (r = {},
                        r.value = n[s]()),
                        null === r)
                        ...
                        i.value = r.value,
                        n[s].construct) {
                            const i = "string" == typeof n[s].construct ? n[s].construct : s;
                            e[s] = t[i]
                        }
                    }
                }
        ...
        696: (e, t, n) => {
            ...
            e.exports = {
                install_in_instance: (e, {parameters: t}) => {
                    ...
                    for (const t of n)
                        e._.init_hooks.push(( () => {
                            e._.context.services.info(t.service).instance.as(s).sub(t.event, t.do.bind(e))
                        }
                        ))
                }
            }
                ...
                install_in_instance: (e, {parameters: t}) => {
                    ...
                    e.mixin(i, {
                        pub: (t, n) => {
                            ...
                            if (s)
                                for (const e of s.listeners_)
                                    e();
                            else
                                console.warn("missing topic: " + s)
                        }
                        ,
                        sub: (t, n) => {
                            const i = e._.topics[t];
                            if (i)
                                return i.listeners_.push(n),
                                new s(i.listeners_,n);
        ...
        475: e => {
            class t {
                ...
                sub(e) {
                    ...
                    for (const e in i)
                        s[e] || Object.defineProperty(n, e, i[e]);
                    return n
                }
            }
            e.exports = {
        ...
        346: (e, t, n) => {
                ...
                static IMPLEMENTS = {
                    [i]: {
                        log(e, t, n, s) {
                            ...
                            o += t,
                            Object.keys(n).length && (o += " ",
                            o += Object.entries(n).map(( ([e,t]) => `\n  ${e}=${i.inspect(t)}`)).join(" ") + "\n"),
            ...
            class a extends s {
                ...
                static IMPLEMENTS = {
                    [i]: {
                        log(e, t, n, s) {
                            return this.delegate.log(e, t, Object.assign({}, this.fields, n), s)
                        }
                    }
                }
            }
                        ...
                        [i]: {
                            log(e, t, n, s) {
                                ...
                                if (this.categories[i])
                                    return this.delegate.log(e, t, n, s)
                            }
                        }
                    };
                    on(e) {
            ...
            class a extends s {
                ...
                get_waiting_for_(e) {
                    ...
                    for (const n of e) {
                        ...
                        e && e.status instanceof this.constructor.StatusRunning || t.push(n)
                    }
                    return t
                }
                async maybe_init_(e) {
    ...
    ( () => {
        ...
        function s(e, t, n, s="post", i="application/json;charset=UTF-8", r=void 0) {
        ...
        function c(e, t, n, s, i={}) {
            return async function(...r) {
                ...
                await async function(e, t, n, s, i, r) {
                    const o = new h;
                    return l(e, o.resolve.bind(o), o.reject.bind(o), t, n, s, i, void 0, void 0, r),
                    await o
                }(a, t, n, s, o, i)
            }
        }
        async function l(t={}, n, r, c, u, d, p, f, g="application/json;charset=UTF-8", m={}) {
            ...
            w.addEventListener("load", (async function(s) {
                    ...
                    r(i);
                {
                    if (!1 === i.success && "permission_denied" === i.error?.code)
                        ...
                        })).granted ? l(t, n, r, c, d, p, f, g, m) : (b(i),
                        r(i));
                    if (!1 === i.success)
                        return b(i),
                        r(i);
        ...
        const p = class {
            ...
            user = function(...e) {
                ...
                let n = "";
                return t?.query && (n = "?" + new URLSearchParams(t.query).toString()),
                new Promise(( (e, i) => {
                    const o = s("/whoami" + n, this.APIOrigin, this.authToken, "get");
        ...
        const m = {
          ...
          , v = ({type: e, data: t}, n, s) => y && t instanceof Blob ? n ? s(t) : _(t, s) : b && (t instanceof ArrayBuffer || w(t)) ? n ? s(t) : _(new Blob([t]), s) : s(f[e] + (t || ""))
          , _ = (e, t) => {
        ...
        const x = "function" == typeof ArrayBuffer
          ...
          , S = (e, t) => "blob" === t ? e instanceof Blob ? e : new Blob([e]) : e instanceof ArrayBuffer ? e : e.buffer
        ...
        class q extends L {
            ...
            onError(e, t, n) {
                return super.emitReserved("error", new j(e,t,n)),
                this
            }
            open() {
        ...
        te.requestsCount = 0,
        te.requests = {},
        "undefined" != typeof document && ("function" == typeof attachEvent ? attachEvent("onunload", ne) : "function" == typeof addEventListener && addEventListener("onpagehide"in R ? "pagehide" : "unload", ne, !1));
        const se = "function" == typeof Promise && "function" == typeof Promise.resolve ? e => Promise.resolve().then(e) : (e, t) => t(e, 0)
            ...
            websocket: class extends q {
                ...
                doOpen() {
                    ...
                    const e = this.uri()
                      ...
                      , n = re ? {} : U(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
        ...
        class Oe extends L {
            ...
            subEvents() {
                if (this.subs)
                    return;
                const e = this.io;
                this.subs = [Se(e, "open", this.onopen.bind(this)), Se(e, "packet", this.onpacket.bind(this)), Se(e, "error", this.onerror.bind(this)), Se(e, "close", this.onclose.bind(this))]
            }
            get active() {
                return !!this.subs
            }
        ...
        class Ce extends L {
            ...
            onopen() {
                ...
                this.emitReserved("open");
                const e = this.engine;
                this.subs.push(Se(e, "ping", this.onping.bind(this)), Se(e, "data", this.ondata.bind(this)), Se(e, "error", this.onerror.bind(this)), Se(e, "close", this.onclose.bind(this)), Se(this.decoder, "decoded", this.ondecoded.bind(this)))
            }
            onping() {
                this.emitReserved("ping")
            }
        ...
        function Le(e, t) {
            ...
            let a;
            return t.forceNew || t["force new connection"] || !1 === t.multiplex || o ? a = new Ce(s,t) : (Me[i] || (Me[i] = new Ce(s,t)),
            a = Me[i]),
        ...
        const Fe = {
            ...
            normalize(e) {
                ...
                return 0 === (e = Ne(e, !t, "/", Be)).length ? t ? "/" : n ? "./" : "." : (n && (e += "/"),
                t ? `/${e}` : e)
            },
            ...
            relative(e, t) {
                ...
                if (a === r)
                    if (i > r) {
                        ...
                        s > r && (e.charCodeAt(1 + a) === Ue ? o = a : 0 === a && (o = 0));
                let c = "";
                for (a = 1 + o + 1; a <= n; ++a)
                    a !== n && e.charCodeAt(a) !== Ue || (c += 0 === c.length ? ".." : "/..");
            ...
            parse(e) {
                ...
                if (-1 !== o) {
                    const s = 0 === r && n ? 1 : r;
                    -1 === i || 0 === l || 1 === l && i === o - 1 && i === r + 1 ? t.base = t.name = e.slice(s, o) : (t.name = e.slice(s, i),
                    t.base = e.slice(s, o),
                    t.ext = e.slice(i, o))
                }
        ...
        e && (e.startsWith("/") || e.startsWith("~") || !puter.appID) || (e = je.join("~/AppData", puter.appID, e))),
        e)
          , ze = function(...e) {
            let t = {};
          ...
          , Xe = function(...e) {
            ...
            new Promise((async (e, n) => {
                ...
                void 0 !== t.uid ? o.uid = t.uid : void 0 !== t.path && (o.path = qe(t.path)),
          ...
          , Ve = async function(n, s, i={}) {
            return new Promise((async (r, o) => {
                ...
                if (Array.isArray(n) && n.length > 0)
                    for (let e = 0; e < n.length; e++)
                        (n[e]instanceof DataTransferItem || n[e]instanceof DataTransferItemList) && (f = !0);
                if (n instanceof DataTransferItemList || n instanceof DataTransferItem || n[0]instanceof DataTransferItem || i.parsedDataTransferItems)
                    h = i.parsedDataTransferItems ? n : await puter.ui.getEntriesFromDataTransferItems(n),
                    h.sort(( (e, t) => e.isDirectory && !t.isDirectory ? -1 : !e.isDirectory && t.isDirectory ? 1 : e.isDirectory && t.isDirectory ? 0 : e.size - t.size));
                else if (n instanceof File || n[0]instanceof File || n instanceof FileList || n[0]instanceof FileList) {
                    h = Array.isArray(n) ? n : n instanceof FileList ? Array.from(n) : [n],
                ...
                for (let e = 0; e < h.length; e++)
                    if (h[e]) {
                        if (h[e].isDirectory)
                            m.push({
                                path: je.join(s, h[e].finalPath ? h[e].finalPath : h[e].fullPath)
                            });
                        else {
                            let t = h[e].finalPath ? h[e].finalPath : h[e].fullPath
                              , [n,r] = [t?.slice(0, t?.lastIndexOf("/")), t?.slice(t?.lastIndexOf("/") + 1)];
                            if ("" != r && b.push(h[e]),
                ...
                for (let e = 0; e < m.length; e++) {
                    for (let t = 0; t < b.length; t++)
                        !b[t].puter_path_param && je.join(s, b[t].filepath).startsWith(m[e].path + "/") && (b[t].puter_path_param = `$dir_${e}/` + je.basename(b[t].filepath));
                    for (let t = 0; t < m.length; t++)
                        !m[t].puter_path_param && m[t].path.startsWith(m[e].path + "/") && (m[t].puter_path_param = `$dir_${e}/` + je.basename(m[t].path))
                }
                for (let e = 0; e < m.length; e++) {
                ...
                for (let e = 0; e < b.length; e++)
                    w.append("operation", JSON.stringify({
                        ...
                        operation_id: l,
                        path: b[e].puter_path_param && je.dirname(b[e].puter_path_param ?? "") || b[e].filepath && je.join(s, je.dirname(b[e].filepath)) || "",
                ...
                c.upload.addEventListener("progress", (function(e) {
                    ...
                    n = n > 100 ? 100 : n,
                    i.progress && "function" == typeof i.progress && i.progress(l, n)
                }
                ));
          ...
          , Ke = function(...e) {
            ...
            new Promise((async (e, n) => {
                ...
                t.path = qe(t.path);
                const i = s("/read?file=" + encodeURIComponent(t.path), this.APIOrigin, this.authToken, "get", "application/json;charset=UTF-8", "blob");
                r(i, t.success, t.error, e, n),
                i.send()
            }
            ))
          ...
          , He = async function(e, t, n={}) {
            ...
            const s = je.basename(e)
              , i = je.dirname(e);
            if ("string" == typeof t ? t = new File([t ?? ""],s ?? "Untitled.txt",{
                type: "text/plain"
          ...
          , Qe = function(...t) {
            ...
            new Promise((async (t, r) => {
                ...
                a.addEventListener("load", (async function(s) {
                    ...
                    if (200 !== this.status)
                        return n.error && "function" == typeof n.error && n.error(i),
                        r(i);
                    {
                        let e, s = i, r = s.token;
                        if (1 == o.length)
                        ...
                        return n.success && "function" == typeof n.success && n.success({
                            token: r,
                            items: e
                        }),
                        t({
                ...
                [tt]: {
                    stat: async function(e) {
                        ...
                        const t = new st.TeePromise
                          , n = new s("/stat",this.api_info.APIOrigin,this.api_info.authToken);
                        r(n, void 0, void 0, t.resolve.bind(t), t.reject.bind(t));
                        let i = {};
                        return void 0 !== e.uid ? i.uid = e.uid : void 0 !== e.path && (i.path = qe(e.path)),
                    ...
                    readdir: async function(e) {
                        this.ensure_auth_();
                        const t = new st.TeePromise
                          , n = new s("/readdir",this.api_info.APIOrigin,this.api_info.authToken);
                        return r(n, void 0, void 0, t.resolve.bind(t), t.reject.bind(t)),
          ...
          , ht = class {
            ...
            getDeveloperProfile = function(...e) {
                ...
                new Promise(( (t, n) => {
                    ...
                    new Promise(( (e, t) => {
                        const n = s("/get-dev-profile", puter.APIOrigin, puter.authToken, "get");
                        r(n, i.success, i.error, e, t),
                        n.send()
                    }
                    ))
                }
        ...
        class gt extends ft {
            ...
            postMessage(e) {
                this.#s ? this.#i ? this.messageTarget.postMessage({
                    msg: "messageToApp",
                    appInstanceID: this.appInstanceID,
                    targetAppInstanceID: this.targetAppInstanceID,
                    targetAppOrigin: "*",
                    contents: e
                }, this.#n) : console.warn("Trying to post message to a non-SDK app") : console.warn("Trying to post message on a closed AppConnection")
            }
            close() {
        ...
        const mt = class extends ft {
            ...
            constructor(e, {appInstanceID: t, parentInstanceID: n}) {
                ...
                this.parentInstanceID && (this.#o = new gt(this.context,{
                ...
                window.addEventListener("message", (async e => {
                    ...
                    if (e.data.msg && "focus" === e.data.msg)
                        ...
                        if ("fileOpenPicked" === e.data.msg) {
                            ...
                            if (1 === e.data.items.length)
                                this.#a[e.data.original_msg_id](new ut({
            ...
            setWindowSize = function(e, t, n, s) {
                return "function" == typeof n ? n = void 0 : "object" == typeof n && null !== n && (n = n.id),
                new Promise((s => {
          ...
          , yt = ["has_set_default_app_user_permissions", "window_sidebar_width", "sidebar_items", "menubar_style", "user_preferences.auto_arrange_desktop", "user_preferences.show_hidden_files", "user_preferences.language", "user_preferences.clock_visible", "has_seen_welcome_window"];
        function bt(e, t) {
            let n = (s = e,
        ...
        const wt = class {
            ...
            async get(...e) {
                return "string" == typeof e[0] && yt.includes(e[0]) && null !== this.gui_cached ? (this.gui_cache_init && this.gui_cache_init.resolve(),
            ...
            list = async (...e) => {
                ...
                c([], "puter-kvstore", void 0, "list", {
                    transform: e => t ? s ? e.filter((e => bt(t, e.key))) : e.filter((e => bt(t, e))) : e
                }).call(this, n)
            }
            ;
          ...
          , vt = class {
            ...
            chat = async (...e) => {
                ...
                ("boolean" == typeof e[1] && !0 === e[1] || "boolean" == typeof e[2] && !0 === e[2] || "boolean" == typeof e[3] && !0 === e[3]) && (s = !0);
                ...
                "claude-3-5-sonnet" !== t.model && "claude" !== t.model || (t.model = "claude-3-5-sonnet-latest"),
                "mistral" === t.model && (t.model = "mistral-large-latest"),
                "groq" === t.model && (t.model = "llama3-8b-8192"),
                "deepseek" === t.model && (t.model = "deepseek-chat"),
                t.model && "gpt-4o" !== t.model && "gpt-4o-mini" !== t.model ? "claude-3-haiku-20240307" === t.model || "claude-3-5-sonnet-20240620" === t.model || "claude-3-5-sonnet-20241022" === t.model || "claude-3-5-sonnet-latest" === t.model ? i = "claude" : "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo" === t.model || "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo" === t.model || "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo" === t.model || "google/gemma-2-27b-it" === t.model ? i = "together-ai" : "mistral-large-latest" === t.model || "codestral-latest" === t.model ? i = "mistral" : ["distil-whisper-large-v3-en", "gemma2-9b-it", "gemma-7b-it", "llama-3.1-70b-versatile", "llama-3.1-8b-instant", "llama3-70b-8192", "llama3-8b-8192", "llama3-groq-70b-8192-tool-use-preview", "llama3-groq-8b-8192-tool-use-preview", "llama-guard-3-8b", "mixtral-8x7b-32768", "whisper-large-v3"].includes(t.model) ? i = "groq" : "grok-beta" === t.model ? i = "xai" : "deepseek-chat" === t.model || "deepseek-reasoner" === t.model ? i = "deepseek" : "gemini-1.5-flash" !== t.model && "gemini-2.0-flash" !== t.model || (i = "gemini") : i = "openai-completion",
                void 0 !== n.stream && "boolean" == typeof n.stream && (t.stream = n.stream);
                const o = ["tools", "response"];
                for (const e of o)
                    n[e] && (t[e] = n[e]);
                return await c(["messages"], "puter-chat-completion", i, "complete", {
                    test_mode: s ?? !1,
          ...
          , _t = class {
            ...
            signIn = () => new Promise(( (e, t) => {
                ...
                window.open(puter.defaultGUIOrigin + "/action/sign-in?embedded_in_popup=true&msg_id=" + n + (window.crossOriginIsolated ? "&cross_origin_isolated=true" : ""), "Puter", "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=600, height=600, top=" + i + ", left=" + s),
        ...
        class St {
            ...
            static response_handlers = {
                "application/x-ndjson": async e => async function*(e) {
                    const t = e.getReader();
                    let n, s;
                    for (; !s && (({value: n, done: s} = await t.read()),
                    !s); ) {
        ...
        class Pt {
            constructor({iface: e, iface_name: t, service_name: n, call_backend: s}) {
                this.iface = e,
                this.iface_name = t,
                this.service_name = n,
                this.call_backend = s
        ...
        class Rt extends et().concepts.Service {
            ...
            init_top_fs_() {
                ...
                this.fs_nocache_ = new ot({
                    api_info: e
                }).as(tt),
                this.fs_cache_ = new rt({
                    delegate: this.fs_nocache_
                }).as(tt),
                this.fs_proxy_ = new nt({
                    delegate: this.fs_nocache_
                }),
        ...
        class Bt extends et().concepts.Service {
            ...
            get_api_info() {
                const e = this
                  , t = {};
                return [["auth_token", "auth_token"], ["authToken", "auth_token"], ["APIOrigin", "api_origin"], ["api_origin", "api_origin"]].forEach(( ([n,s]) => {
        ...
        function Vt(e) {
            ...
            case 5:
                t += 2,
                e.password && (t += 6),
                e.puterAuth && (e.passwordEncoded = Wt.encode(e.puterAuth),
            ...
            switch (s.setUint8(0, e.packetType),
            ...
            case 5:
                s.setUint8(5, 2),
                s.setUint8(6, 0),
                e.password && (s.setUint8(7, 2),
                s.setUint32(8, 1, !0),
                s.setUint8(12, 0)),
                e.puterAuth && (s.setUint8(7, 2),
        ...
        class Ht extends ft {
            ...
            constructor(e, t) {
                ...
                const n = {
                    ...
                    closeCallBack: e => {
                        if (2 !== e)
                            return this.emit("error", new Error(Xt[e])),
            ...
            write(e, t) {
                if (e.buffer)
                    Yt.handler.write(this._streamID, e),
                    t && t();
                else if (e.resize)
                    ...
                    Yt.handler.write(this._streamID, Kt.encode(e)),
                    t && t()
                }
            }
            close() {
            ...
            constructor(e, t) {
                const n = () => {
                    ...
                    this._ws.onmessage = e => {
                        ...
                        switch (s.packetType) {
                        case 2:
                            this.streamMap.get(s.streamID).dataCallBack(s.payload.slice(0));
                            break;
                        case 3:
                            if (0 === s.streamID)
                                return this._bufferMax = s.remainingBuffer,
                            ...
                            break;
                        case 4:
                            0 !== s.streamID && this.streamMap.get(s.streamID).closeCallBack(s.reason);
                            break;
                        case 5:
                            t && this._ws.send(Vt({
                                packetType: 5,
            ...
            const n = {
                request: (n, s) => {
                    ...
                    const m = {
                        data: e => {
                            ...
                            for (let e = 1; e < n.length; e++) {
                                const [t,...s] = n[e].split(":");
                                t && (c.headers[t.toLowerCase().trim()] = s.join(":").trim())
                            }
                            if (g)
                    ...
                    for (const [e,t] of Object.entries(_))
                        A += `${e}: ${t}\r\n`;
                    let k = [];
                    n.data && k.push(n.data),
                    o = new e(n.hostname,n.port ?? t);
        ...
        window.puter = function() {
            const e = new class {
                ...
                constructor(e) {
                    e = e ?? {},
                    this.modules_ = [];
                    const t = (new (et().libs.context.Context)).follow(this, ["env", "util", "authToken", "APIOrigin", "appID"]);
                    t.puter = this,
                    ...
                    n.has("puter.app_instance_id") ? this.env = "app" : !0 === window.puter_gui_enabled ? this.env = "gui" : this.env = "web",
                    "gui" !== this.env && location.hostname.replace(/\.$/, "") === new URL("https://puter.com").hostname && (this.env = "gui"),
                    n.has("puter.args") ? this.args = JSON.parse(decodeURIComponent(n.get("puter.args"))) : this.args = {},
                    n.has("puter.app_instance_id") && (this.appInstanceID = decodeURIComponent(n.get("puter.app_instance_id"))),
                    n.has("puter.parent_instance_id") && (this.parentInstanceID = decodeURIComponent(n.get("puter.parent_instance_id"))),
                    n.has("puter.app.id") && (this.appID = decodeURIComponent(n.get("puter.app.id"))),
                    this.appID && (this.appDataPath = `~/AppData/${this.appID}`),
                    this.APIOrigin = this.defaultAPIOrigin,
                    n.has("puter.api_origin") && "app" === this.env ? this.APIOrigin = decodeURIComponent(n.get("puter.api_origin")) : n.has("puter.domain") && "app" === this.env && (this.APIOrigin = "https://api." + n.get("puter.domain"));
                    let s = new (et().libs.log.ConsoleLogger);
                    s = new (et().libs.log.CategorizedToggleLogger)({
                        delegate: s
                    });
                    const i = s;
                    if (this.log = new (et().libs.log.LoggerFacade)({
                        impl: s,
                        cat: i
                    }),
                    ...
                    (async () => {
                        ...
                        [["authToken", "auth_token"], ["APIOrigin", "api_origin"]].forEach(( ([t,n]) => {
